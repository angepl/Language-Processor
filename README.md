...
## Information about variables and functions of the project
- **character** (variable inside LexicalAnalyzer class) - refers to the last character that was read by the Lexical Analyzer and represents the column of the Transmition Matrix in the Lexical Analysis
...
- **paramTypes** (field of Element class) - holds the types of the arguments of the element in the symbol table, in case it is a function
